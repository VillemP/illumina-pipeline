...
vcf_storage_location = "/media/kasutaja/data/TSC_temp/miniseq_pipe/vcfs-test/"
...
def update_vcf_list(samples, overwrite=False):
    ...
    with open(db_vcf_dir, "a+") as db_vcfs:
        ...
        # db_vcfs.seek(0)
        curr_len = DatabaseCrawler.file_len(db_vcf_dir)
    ...
    print ("Updated {0} with {1} unique samples. "
        ...
        os.path.realpath(db_vcf_list_name), i, skipped, db_name)
